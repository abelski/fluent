  ...
  if (error || !detail) {
    return (
      <main className="min-h-screen bg-[#F5F5F7] flex flex-col items-center justify-center px-6 gap-4">
        ...
        <Link href="/dashboard/lists" className="text-sm text-emerald-600 hover:text-emerald-700"><TakChevron direction="left" size={10} className="inline-block align-[-1px] mr-1" />{t.backToLists}</Link>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-[#F5F5F7] text-gray-900 flex flex-col items-center px-4 py-10" data-testid="word-list-edit-page">
      <div className="relative z-10 w-full max-w-2xl">
        <div className="mb-6">
          <Link href="/dashboard/lists" className="text-sm text-gray-400 hover:text-gray-900 transition-colors"><TakChevron direction="left" size={10} className="inline-block align-[-1px] mr-1" />{t.backToLists}</Link>
        </div>
